...
# ==========================================
# 1. CONSTANTES TERMODINÁMICAS Y PSICROMETRÍA (SANITIZADAS)
# ==========================================
...
# ==========================================
# 3. CONTROLADOR PID DISCRETO PROTEGIDO
# ==========================================
...
class SimularDinamicaWorker(QThread):
    ...
    def run(self):
        try:
            ...
            # FASE DE WARM-UP (10 iteraciones silenciosas)
            tdb_0 = tdb_interp[0]
            twb_0 = twb_interp[0]
            ...
            times, t_out_arr, t_in_arr, fan_speed_arr, t_wb_arr, t_db_arr, t_a_out_arr, evap_arr, q_mwt_arr = [], [], [], [], [], [], [], [], []
            ...
            for idx, sec in enumerate(time_steps_sec):
                ...
                T_salida_inst, evap_kg_s, _, _, Matriz_T_a, _ = simular_torre_2d_matriz(
...
class VentanaSimulacionDinamica(QDialog):
    ...
    def init_ui(self):
        ...
        for chk in [self.chk_tin, self.chk_tout, self.chk_speed, self.chk_twb, 
                    self.chk_tdb, self.chk_taout, self.chk_q, self.chk_evap]:
    ...
    def replot(self):
        ...
        if ax_top is not None:
            ...
            if mostrar_velocidad:
                ...
                lines.append(l3)
                ax_speed.set_ylabel("Velocidad (%)", color='#27AE60', fontsize=8)
...
class TorreCoolingApp(QMainWindow):
    ...
    def lanzar_worker(self, datos_p1, datos_p2=None):
        ...
        # Instanciar el hilo local CalibracionWorker
