model Torre_Merkel "Test model for cooling tower using the Merkel theory"
  ...
  extends Buildings.Fluid.HeatExchangers.CoolingTowers.Examples.BaseClasses.PartialStaticTwoPortCoolingTower(
    ...
    redeclare Buildings.Fluid.HeatExchangers.CoolingTowers.Merkel tow(
      ...
      PFan_nominal=4800),
    weaDat(final computeWetBulbTemperature=true, filNam="C:/Users/Jose/Documents/ModelicaBuildings/Buildings 12.1.0/Resources/weatherdata/Buenos.Aires-Newbery.Intl.AP.mos"));
