...
# ==========================================
# 2. MOTOR POPPE 2D CON EVAPORACIÓN PROTEGIDA
# ==========================================
...
# ==========================================
# 5. HILO DE SIMULACIÓN CON INICIALIZACIÓN ESTACIONARIA REAL
# ==========================================
...
class SimularDinamicaWorker(QThread):
    ...
    def run(self):
        try:
            ...
            # Carga térmica firme del proceso (11.1°C fijos desde el inicio)
            ...
            # --- CONVERGENCIA PREVIA EN ESTADO ESTACIONARIO (Warm-up Real) ---
            tdb_0 = tdb_interp[0]
            twb_0 = twb_interp[0]
            ...
            # Estimar punto de equilibrio de la piscina para el primer instante
...
class VentanaSimulacionDinamica(QDialog):
    def __init__(self, parent=None, datos_torre=None):
        super().__init__(parent)
        self.setWindowTitle("Simulación Dinámica Anual / Climática (.EPW) con PID y Energía")
    ...
    def init_ui(self):
        ...
        self.lbl_kwh_total = QLabel("Energía Consumida: -- kWh")
        self.lbl_kwh_total.setFont(QFont("Segoe UI", 9, QFont.Bold))
        self.lbl_kwh_total.setStyleSheet("color: #2980B9; padding-top: 2px;")
        layout_cfg.addWidget(self.lbl_kwh_total)

        self.lbl_m3_total = QLabel("Agua Consumida: -- m³")
        self.lbl_m3_total.setFont(QFont("Segoe UI", 9, QFont.Bold))
        self.lbl_m3_total.setStyleSheet("color: #D35400; padding-top: 1px;")
        layout_cfg.addWidget(self.lbl_m3_total)
    ...
    def procesar_exito(self, res):
        ...
        self.res_sim = res
        self.lbl_kwh_total.setText(f"Energía Consumida: {res['energia_total_kwh']:.2f} kWh")
        self.lbl_m3_total.setText(f"Agua Consumida: {res['agua_total_m3']:.2f} m³")
        self.replot()
