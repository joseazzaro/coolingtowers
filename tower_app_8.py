    ...
    def run(self):
        try:
            ...
            for idx, sec in enumerate(time_steps_sec):
                ...
                if HAS_COOLPROP:
                    try:
                        w_a_in = CP.HAPropsSI('W', 'T', tdb_k + 273.15, 'B', twb_k + 273.15, 'P', patm_k)
                        h_a_in = CP.HAPropsSI('H', 'T', tdb_k + 273.15, 'B', twb_k + 273.15, 'P', patm_k) / 1000.0
                    except Exception:
...
class TorreCoolingApp(QMainWindow):
    ...
    def lanzar_worker(self, datos_p1, datos_p2=None):
        """Lanza el hilo de calibración interno."""
