...
# ==========================================
# 5. HILO DE SIMULACIÓN DINÁMICA CON BALANCE HÍDRICO COMPLETO (E + D + B)
# ==========================================
...
class SimularDinamicaWorker(QThread):
    ...
    def run(self):
        try:
            ...
            # Parámetros de Purga y Drift
            pct_drift = float(self.cfg.get('pct_drift', 0.005)) # Default 0.005%
            coc = float(self.cfg.get('coc', 4.0))                # Default COC = 4
            ...
            # --- SOLUCIÓN: ACOPLAR EL PID Y LA PISCINA AL BUCLE REAL ---
            pid.prev_error = T_piscina - T_set  # Evita el "kick" derivativo/proporcional al arrancar
            ...
            # Caudal instantáneo de Drift (m3/h)
            ...
            for idx in range(total_pasos):
                ...
                # CÁLCULO DE PURGA E INSUMO TOTAL (E + D + B)
...
class VentanaSimulacionDinamica(QDialog):
    def __init__(self, parent=None, datos_torre=None):
        super().__init__(parent)
        self.setWindowTitle("Simulación Dinámica Anual / Climática (.EPW) con PID y Balance Hídrco")
    ...
    def init_ui(self):
        ...
        # 2. Rango Temporal, Estanque y Parámetros Hídricos
        ...
        self.txt_coc = QLineEdit("4.0")           # Ciclos de Concentración
        self.txt_drift = QLineEdit("0.005")       # % Drift
        ...
        # BLOQUE COMPLETO DE KPIs HÍDRICOS Y ENERGÉTICOS EN PANEL IZQUIERDO
    ...
    def procesar_exito(self, res):
        ...
        # ACTUALIZACIÓN DE ETIQUETAS DE KPIS Y BALANCE HÍDRICO COMPLETO
    ...
    def replot(self):
        ...
        if ax_top is not None:
            # === CORRECCIÓN VISUAL DE NIEBLA (BLOQUES CONTINUOS Y SIN RAYAS) ===
