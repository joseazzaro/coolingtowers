...
# ==========================================
# 5. HILO DE SIMULACIÓN (CON CORRECCIÓN DE ACUMULADORES)
# ==========================================
...
class SimularDinamicaWorker(QThread):
    ...
    def run(self):
        try:
            ...
            # Warm-up (30 ciclos de aclimantación previa)
            tdb_0 = tdb_interp[0]
            twb_0 = twb_interp[0]
            ...
            # REINICIO LIMPIO DE ACUMULADORES DE ENERGÍA Y AGUA DE LA SIMULACIÓN REAL
...
class VentanaSimulacionDinamica(QDialog):
    ...
    def init_ui(self):
        ...
        # ETIQUETAS DE MÉTRICAS EN PANEL IZQUIERDO
